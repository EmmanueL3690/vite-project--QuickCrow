    ...
    <footer className="footer">
      ...
      <div className="footer-top">
        ...
        <div className="footer-left">
          ...
          {showText && (
            <div className="typewriter">
              Bringing comfort food to your comfort zone. Your favorite flavors, always close. <br />
              Make hunger no disgrace you — order now! Hustle no be excuse to starve. We dey for you!
            </div>
          )}
        </div>
        ...
        <div className="footer-center">
          ...
          <p><i className="fas fa-envelope"></i> Email: Emma@example.com</p>
